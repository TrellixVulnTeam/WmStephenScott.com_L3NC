		    ...
		    $('h2#'+skill).mouseenter(function(){
				...
				$('div#feedbackFormDiv').hide();
		    		...
		    		if (skill == 'GIS') {text = "<p id='popupText' class='destroyMe'> I love geospatial data.  Using raster GIS methods I can conduct statistical analyses, such as modeling future real estate values, or determining how much more individuals are willing to pay to be near a transit stop. I am skilled in ESRI's ArcInfo, but increasingly I am moving toward QGIS, a powerful open-source alternative. I am active in the Code For America brigades, where I share my GIS knowledge with others.</p>";
		    							...
		    							image = "<iframe width='100%' height='520' frameborder='0' src='http://wmstephenscott.cartodb.com/viz/1ed90f14-a3c5-11e3-b512-0edbca4b5057/embed_map?title=true&description=true&search=false&shareable=true&cartodb_logo=true&layer_selector=false&legends=false&scrollwheel=true&fullscreen=false&sublayer_options=1&sql=&sw_lat=39.51887357127223&sw_lon=-76.31378173828125&ne_lat=40.35073056591789&ne_lon=-74.07257080078125' allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>"
		    							}
