		 ...
		 //	$('#imageColumn').removeChild('popupImage')
		    ...
		    $('h2#'+skill).mouseenter(function(){
				...
				$('div#imageColumn').empty();
		    		...
		    		else if (skill == 'UrbanDesign') {text = "<p>Diversity and complexity at all scales serving human needs is my driving aesthetic vision.  I call the principle 'intimate modernity', intimate, because it exists on all scales, and modern, because of its utilitarian sense of urgency.  My design experience is thoroughly informed by the work of Ed Bacon and I.M. Pei and their designs for Philadelphia, as well as early Soviet theories of creating 'social condensors' where people can interact.  Good design brings people together, acting as a lattice upon which social interaction unfolds.  This requires a diversity of spaces, from the private nook, to spaces for small groups, to large civic spaces for congregations of citizens.  I belive good urban design is not just 'walkable', but the entire environment is scaled to the human body.  Detail and ornament on the micro-scale is important and is sorely lacking in modernist design generally.  To solve this problem of ornementatal richness, algorithmic design, digital sculpture, and digital fabrication will in the future fill the demand for rich, complex detailing. </p>";
