		    ...
		    $('h2#'+skill).mouseenter(function(){
				...
				$('div#feedbackFormDiv').hide();
		    		...
		    		//								}
		    											...
		    											image = "<div img id='popupImage' class='.image-showcase' class = 'destroyMe' width = '500px>    <div><img src='static/img/3dModeling/lookingup.png' width='500px'></div>            <div><img src='static/img/architecture/Axons-01.png' width='500px'></div>            <div><img src='static/img/architecture/perspective.png' width='500px'></div>         </div>   ";
		    											}
